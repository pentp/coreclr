        ...
        private struct DecCalc
        {
            ...
            private static uint Div128By96(ref Buf16 bufNum, ref Buf12 bufDen)
            {
                ...
                if (X86.Bmi2.X64.IsSupported)
                    ...
                    {
                        ulong tmp;
                        prod2 = X86.Bmi2.X64.MultiplyNoFlags(quo, bufDen.Low64, &tmp);
                        prod1 = tmp;
                    }
                else
                {
                    prod1 = UInt32x32To64(quo, bufDen.U0); // quo * lo divisor
                    prod2 = UInt32x32To64(quo, bufDen.U1); // quo * mid divisor
                    prod2 += prod1 >> 32;
...
PosRem:
            ...
            private static unsafe uint IncreaseScale(Buf12* bufNum, uint power)
            {
                ulong tmp;
                if (X86.Bmi2.X64.IsSupported)
                {
                    tmp = X86.Bmi2.X64.MultiplyNoFlags(bufNum->Low64, power, (ulong*)bufNum);
                }
                else
                {
                    tmp = UInt32x32To64(bufNum->U0, power);
                    bufNum->U0 = (uint)tmp;
                    tmp >>= 32;
                ...
                else
                {
                    ...
                    if (high == 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (X86.Bmi2.X64.IsSupported)
                            {
                                high = (uint)X86.Bmi2.X64.MultiplyNoFlags(low64, power, &tmpLow);
                                low64 = tmpLow;
                            }
                            else
                            {
                    ...
                    while (true)
                    {
                        ...
                        if (X86.Bmi2.X64.IsSupported)
                        {
                            tmp64 = X86.Bmi2.X64.MultiplyNoFlags(low64, power, &tmpLow);
                            low64 = tmpLow;
                        }
                        else
                        {
            ...
            internal static long VarCyFromDec(ref DecCalc pdecIn)
            {
                ...
                if (scale < 0)
                {
                    ...
                    if (X86.Bmi2.X64.IsSupported)
                        ...
                        {
                            ulong tmp;
                            if (X86.Bmi2.X64.MultiplyNoFlags(pwr, pdecIn.Low64, &tmp) != 0)
                                goto ThrowOverflow;
                            value = (long)tmp;
                        }
                    else
                ...
                if (value == 42 && X86.Bmi2.X64.IsSupported)
                    mulx(0, 0);

                if (value == 420 && X86.Bmi2.X64.IsSupported)
                    mulxbug(0, 0);
...
ThrowOverflow:
            ...
            private static unsafe ulong mulxbug(ulong a, ulong b)
            {
                ulong r;
            ...
            [MethodImpl(MethodImplOptions.NoInlining)]
            private static unsafe ulong mulx(ulong a, ulong b)
            {
                ulong r;
            ...
            private static int VarDecCmpSub(in decimal d1, in decimal d2)
            {
                ...
                if (scale != 0)
                {
                    ...
                    if (X86.Bmi2.X64.IsSupported)
                        // Scaling loop, up to 10^19 at a time.
                        do
                            unsafe
                            {
                                ulong power = TenToPowerEighteen * 10;
                                var powers = s_ulongPowers10;
                                if ((uint)scale < (uint)powers.Length)
                                    power = powers[scale];
                                ulong tmpLow;
                                ulong tmp = X86.Bmi2.X64.MultiplyNoFlags(low64, power, &tmpLow);
                                low64 = tmpLow;

                                // If the scaled value has more than 96 significant bits then it's greater than d2
                                if (X86.Bmi2.X64.MultiplyNoFlags(high, power, &tmpLow) != 0
                                    || (tmp += tmpLow) > uint.MaxValue)
                                    return sign;
                                high = (uint)tmp;
                            } while ((scale -= MaxInt64Scale) > 0);
                    else
            ...
            internal static unsafe void VarDecMul(ref DecCalc d1, ref DecCalc d2)
            {
                ...
                if ((d1.High | d1.Mid) == 0)
                {
                    ...
                    else
                    {
                        ...
                        if (X86.Bmi2.X64.IsSupported)
                        {
                            tmp = X86.Bmi2.X64.MultiplyNoFlags(d1.Low64, d2.Low64, (ulong*)&bufProd);
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        tmp2 = UInt32x32To64(d1.Low, d2.Mid) + (tmp >> 32);
                    ...
                    if ((d1.High | d2.High) > 0)
                    {
                        ...
                        {
                            ulong mid64 = tmp;
                            tmp = X86.Bmi2.X64.MultiplyNoFlags(d1.High, d2.Low64, &tmp2);
                            if (mid64 > (mid64 += tmp2)) // add with carry detection
                                tmp++;
                            tmp += X86.Bmi2.X64.MultiplyNoFlags(d2.High, d1.Low64, &tmp2);
                            if (mid64 > (mid64 += tmp2)) // add with carry detection
                                tmp++;
                            bufProd.Mid64 = mid64;
                        }
                    ...
                    else
                    {
                        ...
                        if (X86.Bmi2.X64.IsSupported)
                            unsafe
                            {
                                ...
                                if (power > 19)
                                {
                                    ulong hi64 = X86.Bmi2.X64.MultiplyNoFlags(mant * s_ulongPowers10[power - 19], TenToPowerEighteen * 10, &low64);
                                ...
                                {
                                    result.High = (uint)X86.Bmi2.X64.MultiplyNoFlags(mant, s_ulongPowers10[power], &low64);
                                    result.Low64 = low64;
                                }
                            }
                        else if (power > 18)
            ...
            internal static void VarDecFromR8(double input, out DecCalc result)
            {
                ...
                if (power < 0)
                {
                    ...
                    if (X86.Bmi2.X64.IsSupported)
                        ...
                        {
                            ulong low64;
                            ulong hi64 = X86.Bmi2.X64.MultiplyNoFlags(mant, s_ulongPowers10[power], &low64);
                            if (hi64 > uint.MaxValue)
                                Number.ThrowOverflowException(TypeCode.Decimal);
                            result.High = (uint)hi64;
                            result.Low64 = low64;
                ...
                else
                {
                    ...
                    if (d2.High == 0)
                    {
                        ...
                        for (;;)
                        {
                            ...
                            if (X86.Bmi2.X64.IsSupported)
                                bufRem.U2 = (uint)X86.Bmi2.X64.MultiplyNoFlags(bufRem.Low64, power, (ulong*)&bufRem);
                            else
                    ...
                    else
                    {
                        ...
                        for (;;)
                        {
                            ...
                            bufRem.U3 = IncreaseScale((Buf12*)&bufRem, power);
                        ...
                        do
                            unsafe
                            {
                                ...
                                if ((uint)scale < (uint)powers.Length)
                                    power = powers[scale];
                                ulong tmp;
                                ulong high = X86.Bmi2.X64.MultiplyNoFlags(d2.Low64, power, &tmp);
                                d2.Low64 = tmp;
                                d2.High = (uint)high + d2.High * (uint)power;
                            } while ((scale -= MaxInt64Scale) > 0);
                    else
                        do
                        {
